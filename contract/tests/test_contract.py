...
class TestContractBase(common.SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.line_template_vals = {
            ...
            'quantity': 1,
            'product_uom_id': cls.product_1.product_uom_id.id,
            'price_unit': 100,
            'discount': 50,
...
class TestContract(TestContractBase):
    ...
    def test_contract(self):
        ...
        self.assertIn('product_uom_id', res['domain'])
    ...
    def test_uom(self):
        ...
        self.acct_line.product_uom_id = uom_litre.id
        self.acct_line._onchange_product_id()
        self.assertEqual(
            self.acct_line.product_uom_id, self.acct_line.product_id.product_uom_id
        )
            ...
            'contract_line_ids': [
                ...
                (
                    ...
                    0,
                    {
                        ...
                        'name': 'Services from #START# to #END#',
                        'quantity': 1,
                        'product_uom_id': self.product_1.product_uom_id.id,
                        'price_unit': 100,
                        'discount': 50,
                        'recurring_rule_type': 'yearly',
                        'recurring_interval': 1,
    ...
    def test_contract_onchange_product_id_domain(self):
        ...
        self.assertEqual(
            ...
            ('category_id', '=', self.product_1.product_uom_id.category_id.id),
        )

    def test_contract_onchange_product_id_uom(self):
        """It should update the UoM for the line."""
        line = self._add_template_line(
            {'product_uom_id': self.env.ref('uom.product_uom_litre').id}
        )
        line.product_id.product_uom_id = self.env.ref('uom.product_uom_day').id
        line._onchange_product_id()
        self.assertEqual(line.product_uom_id, line.product_id.product_uom_id)
    ...
    def test_contract_manually_create_invoice(self):
        ...
        self.assertEqual(invoice_lines.mapped('move_id'), invoices)
