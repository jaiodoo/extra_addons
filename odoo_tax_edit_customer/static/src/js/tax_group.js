odoo.define('odoo_tax_edit_customer.tax_group', function (require) {
  "use strict";
    ...
    var TaxGroupCustomerCustomField = AbstractField.extend({
        events: {
        ...
        _isPurchaseDocument: function () {
            return this.record.data.type === "in_invoice" || this.record.data.type === 'in_refund' || this.record.data.type === "out_invoice" || this.record.data.type === 'out_refund';
        },
        ...
        _render: function () {
            ...
            this.$el.html($(QWeb.render('AccountTaxGroupTemplateCustomer', {
                lines: self.value,
    ...
    fieldRegistry.add('tax-group-custom-field-customer', TaxGroupCustomerCustomField)
});
